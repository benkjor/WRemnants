...
from wums.boostHistHelpers import broadcastSystHist, divideHists, multiplyHists
...
mass_mc_2d = all_mc_corrections(mass_mc, time_mll_data)
stight_strig_mc_2d = all_mc_corrections(stight_strig_mc, time_mll_data)
dtight_strig_mc_2d = all_mc_corrections(dtight_strig_mc, time_mll_data)
generator_2d = all_mc_corrections(generator, time_mll_data)
...
make_plot(
    [
        mass_sum_mc,
        mass_sum_data,
        mass_sum_stight_strig_mc,
        mass_sum_stight_strig_data,
        mass_sum_dtight_strig_mc,
        mass_sum_dtight_strig_data,
        mass_sum_generator,
    ],
    "mass_sum_all",
    legend_all=[
