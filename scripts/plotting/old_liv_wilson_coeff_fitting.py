...
data = results_data["results_asimov"]["mappings"]["BaseMapping"]["channels"]["ch_iso"][
    "hist_postfit_inclusive"
].get()
pdb.set_trace()
# data_cov = results_data["results_asimov"]["mappings"]["BaseMapping"]["channels"]["ch_iso"][  "hist_postfit_inclusive_cov"].get()
